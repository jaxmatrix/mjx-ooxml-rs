...
impl Presentation {
    ...
    /// The ZIP names of every part this presentation has dirtied — the **dirty set** a batched commit
    ...
    ///
    /// This is the *commit* half of copy-on-write, for a caller that keeps this presentation open across
    ...
    ///
    /// A caller that saves once and drops the presentation has no reason to call this: [`save`](Self::save)
