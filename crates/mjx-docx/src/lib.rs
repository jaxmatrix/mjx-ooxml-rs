...
pub use document::{
    ...
    BottomPageBorder, Break, CharacterStyle, Color, Column, Columns, ColumnsContent,
    ConditionalFormatting, ConditionalFormattingBits, DecimalNumberValue,
    ...
    EffectiveShading, EffectiveTabStop, EffectiveUnderline, Emphasis, Fonts, FrameProperties,
    HalfPoint, HalfPointMeasureValue, HeaderFooterReference, HexColor, HexIdentifier, Highlight,
    Hyperlink, Indentation, Lang, Languages, LatentStyleContent, LatentStyleException,
    LatentStyles, LevelLegacyFormatting, LevelNumberFormat, LevelSuffix, LevelTextSegment,
    LevelTextTemplate, LineNumbering, LineSpacing, LinkedStyleResolution, LongHex, MainDocument,
    ...
    SignedTwipsMeasureValue, Spacing, StyleDefinition, StyleDefinitionContent, StyleIndex,
    StyleParagraphProperties, StyleParagraphPropertyContent, StyleSheet, StyleSheetContent,
    StyleString, Symbol, TabStop, TabStopContent, TabStops, TableStyleOverride,
    TableStyleOverrideContent, Text, TextBoxTightWrapSetting, TextEffect, TextScaleValue,
    ThemeHexDigit, Toggle, TopPageBorder, Twips, Underline, Unmodeled, VerticalAlignment,
