...
pub use document::{
    ...
    EffectiveShading, EffectiveTabStop, EffectiveUnderline, Emphasis, Field, FieldCharacter,
    FieldCharacterContent, FieldForm, FieldPath, FloatingTableOverlap, FloatingTablePosition,
    Fonts, FormFieldCheckBox, FormFieldCheckBoxContent, FormFieldData, FormFieldDataContent,
    FormFieldDropDownList, FormFieldDropDownListContent, FormFieldHelpTextElement,
    FormFieldNameElement, FormFieldStatusTextElement, FormFieldTextInput,
    ...
    MergeMarker, MergedCellType, MultiLevelKind, Numbering, NumberingContent, NumberingIndex,
    ...
    ParagraphBorders, ParagraphContent, ParagraphMarkRunProperties,
    ...
    SimpleField, Spacing, StringElement, StyleDefinition, StyleDefinitionContent, StyleIndex,
    StyleParagraphProperties, StyleParagraphPropertyContent, StyleSheet, StyleSheetContent,
    StyleString, Symbol, TabStop, TabStopContent, TabStops, Table, TableAlignment,
    TableBorderContent, TableBorders, TableCellMargins, TableContent, TableExceptionProperties,
    TableExceptionPropertyContent, TableLayout, TableLook, TableLookFlags, TableProperties,
    TablePropertyContent, TableStringValue, TableStyleOverride, TableStyleOverrideContent,
    TableWidth, TableWidthMeasure, Text, TextBoxTightWrapSetting, TextEffect, TextScaleValue,
    ThemeHexDigit, Toggle, TopPageBorder, Twips, Underline, Unmodeled, UnsignedDecimalNumberValue,
    VerticalAlignment, VerticalCharacterAlignment, WhitespacePreservation,
    MAX_BASED_ON_CHAIN_DEPTH, MAX_NUM_STYLE_LINK_DEPTH,
};
