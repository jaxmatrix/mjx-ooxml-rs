...
pub use document::{
    ...
    EastAsianLayout, EffectiveBorder, EffectiveCharacterProperties, EffectiveColor,
    ...
    HalfPoint, HalfPointMeasureValue, HexColor, HexIdentifier, Highlight, Hyperlink, Indentation,
    Lang, Languages, LatentStyleContent, LatentStyleException, LatentStyles, LevelLegacyFormatting,
