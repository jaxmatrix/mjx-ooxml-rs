...
pub use document::{
    ...
    HalfPoint, HalfPointMeasureValue, HdrFtr, HeaderFooterReference, HeaderFooterType, HexColor,
    ...
    LevelTextSegment, LevelTextTemplate, LineNumbering, LineSpacing, LinkedStyleResolution,
    LongHex, MainDocument, MainDocumentContent, ManualRunWidth, MultiLevelKind, Numbering,
