 ...
 * Format, Excel's Table Design and Picture Format, every Shape Format, and Word's Chart Design; the other contextual tabs
 * of the four common sets, PowerPoint's and Excel's Chart Design and every Chart Tools Format, are what still draw
