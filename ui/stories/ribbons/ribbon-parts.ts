 ...
 * Format, Excel's Table Design and Picture Format, every Shape Format, every Chart Design, and Word's Chart Format; the
 * other contextual tabs of the four common sets, PowerPoint's and Excel's Chart Tools Format, are what still draw through
