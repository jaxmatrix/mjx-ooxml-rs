 ...
 *
 * **Every core and view tab has landed, and so have Word's Table Design and Table Layout and PowerPoint's Table
 * Design; the other contextual tabs of the four common sets are what still draw through this**, each until its own
 * unit authors it.
 *
