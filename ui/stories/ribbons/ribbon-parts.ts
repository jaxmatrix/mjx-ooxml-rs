 ...
 * Format, Excel's Table Design and Picture Format, and every Shape Format; the other contextual tabs of the four common
 * sets, Chart Design and Format, are what still draw through this**, each until its own unit authors it.
 *
